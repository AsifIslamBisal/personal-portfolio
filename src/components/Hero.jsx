...
const profile = {
    ...
    stack: [
        ...
        'MongoDB', 'MySQL', 'TypeScript', 'Git & GitHub'
    ],
    traits: {
        hardWorker: true,
        quickLearner: true,
        problemSolver: true,
        developmentJourney: 1y+,
        dedicated: true,
        teamPlayer: 'Learning through group projects and collaboration'
    },
    hireable() {
        const boolTraits = Object.values(this.traits).filter(v => typeof v === 'boolean');
        const hasGoodTraits = boolTraits.every(Boolean);
        const skilledEnough = this.stack.length >= 8;
        return hasGoodTraits && skilledEnough;
    }
};

console.log("Is Asif hireable?", profile.hireable()); // true
`);
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  👨‍💻 Junior MERN Stack Developer | Building clean and modern web applications 🌐 & Learning new Technologys
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/AsifIslamBisal"
