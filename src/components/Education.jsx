  ...
  const educationData = [
    {
      ...
      school: "Technical Training Center, Rajshahi",
      mascot: "📘",
      year: "2021-2022",
      achievements: ["GPA : 5.00", "Subject : Automotive(Science)"],
      skills: ["Mathematics", "Physics", "Chemistry", "Automotive1", "Automotive2"],
      description:
        "Focused on core automotive & science subjects with emphasis on practical laboratory work.",
    },
    {
